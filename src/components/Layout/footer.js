const Footer = () => {
  return (
    <footer className="w-full  flex items-center justify-center bg-indigo-600">
      <div className="max-w-5xl mx-auto px-4 text-white flex flex-col">
        <div className="w-full text-7xl font-bold pt-4">
          <h1 className="w-full md:w-2/3">The place where you can help </h1>
        </div>
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-200 font-semibold">
            Stack Overflow is a question and answer website htmlFor professional and
        ...
        <div className="flex flex-col">
          <div className="flex mt-24 mb-12 flex-row justify-between">
            <div className="-mt-1">
              <h1 className="text-xl">Qgram</h1>
            </div>
            <a className="hidden md:block cursor-pointer text-gray-100 hover:text-gray-300 uppercase">
              Home
            </a>
            <a className="hidden md:block cursor-pointer text-gray-100 hover:text-gray-300 uppercase">
              Questions
